...
BUILD_WIN_CMD="cd $(CMDDIR) && $(GOBUILD_WIN) -gcflags=-trimpath=$GOPATH -asmflags=-trimpath=$GOPATH -trimpath -ldflags $(RELEASE_LDFLAGS) -o $(BUILDDIR)/$(PROGRAM).exe -v -tags '$(BUILD_TAGS)'"
